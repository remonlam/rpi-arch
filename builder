...
echo "Untar ArchLinuxARM to root filestem"
...
dd bs=1000000 if=/dev/sdc of=/root/builds/ArchLinux_ARMv6_Pi_Baseline_v$version.img

## Copy file to Mac desktop
echo "Copy files to mac, this, can take some time"
scp builds/ArchLinux_ARMv6_Pi_Baseline_v$version.img user@10.10.10.10:/tmp_builder
